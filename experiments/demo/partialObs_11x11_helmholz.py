...
# ── Inverse problem HMC (Helmholtz, 11×11 partial observations) ───────────────
samples.InverseProblemHMC(
    ...
    path=os.path.join(SESSION_DIR, 'partialObs_11x11_helmholz.pt'),
)

# ── Plot ──────────────────────────────────────────────────────────────────────
post.plotInversePaper(
    data_path=os.path.join(SESSION_DIR, 'partialObs_11x11_helmholz.pt'), name='partialObs_11x11_helmholz'
)
